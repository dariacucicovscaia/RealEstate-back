...
public class XLSXReportingServiceImplTest {

    private XLSXReportingService serviceUnderTest;

    @Before
    public void before() {
        serviceUnderTest = new XLSXReportingServiceImpl();
    }
    ...
    public void saveFileTest() {
        ...
        String path = serviceUnderTest.saveFile(sheetName, fileName, body);
